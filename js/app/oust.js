...
// var _dhisSiteURL = _appManifest.activities.dhis.href.replace( '/dhis-web-appmanager', '' ) + '/';
...
var selectionTreePath = _appURL + 'dhis-web-commons/oust/';
...
function SelectionTreeSelection()
{
    ...
    function responseReceived( json )
    {
        ...
        for ( i in json.selectedUnits ) 
        {
            ...
            selectedOrganisationUnitName.push(unitNames[i]);
        }
