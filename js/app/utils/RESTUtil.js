...
RESTUtil.getAsyncData = function( url, actionSuccess, actionError, loadingStart, loadingEnd ) 
{
	return $.ajax({
		type: "GET"
		,dataType: "json"
	...
	.always( function( data ) {
		if ( loadingEnd !== undefined ) loadingEnd( data );
	});
};
...
RESTUtil.getAddDataAction = function( url, json_Data, actionSuccess, doneFunc )
{
	return $.ajax({
		type: "POST"
		,url: url
...
RESTUtil.getEditDataAction = function( url, json_Data, actionSuccess, doneFunc )
{
	return $.ajax({
		type: "PUT"
		,url: url
...
RESTUtil.getDeleteData = function( url, actionSuccess, actionDone )
{
	return $.ajax({
		type: "DELETE"
		,url: url
